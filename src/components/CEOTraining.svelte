<section id="ceo-training" class="text-xl p-4">
  ...
  <div class="flex gap-12 px-4 py-12">
    <div class="flex flex-col justify-center flex-1">
      <p>
        ¿Sabías que el verdadero crecimiento como líder ocurre cuando te rodeas
      ...
      <ul class="flex flex-col gap-4 list-disc my-8 mx-8 text-justify">
        ...
        <li>
          ...
          creando nuevas conexiones neuronales y trabajando en la inteligencia que
          más dinero te va a dejar: la inteligencia emocional.
        </li>
        <li>
        ...
        <li>
          ...
          La riqueza es todo aquello que te queda cuando te quedas sin dinero: contactos,
          talentos, conocimientos y felicidad.
        </li>
        <li>
          <b>Módulo de rebeldía:</b> Sé tan rebelde como para tomar decisiones impopulares
          sin culpa y vivir con ligereza. Saldrás con tres documentos esenciales:
          tus políticas de vida, tu filosofía personal y un master plan para los
          próximos tres años.
        </li>
      </ul>
      ...
      <ul class="flex flex-col gap-4 list-disc my-8 mx-8 text-justify">
        <li>
          <b>Clases de yoga semanales:</b> Para desarrollar una mente flexible en
          un cuerpo flexible.
        </li>
        <li>
        ...
        <li>
          ...
          siguiendo instrucciones y esperando oportunidades, en lugar de crear tu
